// - Function StringChallenge1(str) takes the str parameter and
...
console.log(StringChallenge1("hello world")); // Output: "Hel_o W_rld"
console.log(StringChallenge1("i ran there")); // Output: "I R_n T_ere"